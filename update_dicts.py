...
new_ucs_dims = """const UCS = [
  ...
  { id:'AMUS', name:'Amusement / Casino', zh:'遊樂場 / 博弈賭場', color:'#5b9fff',
    ...
    keywords:{ en:['amusement','casino','arcade','slot machine','jackpot','roulette','gamble','pinball','coin drop','win','collect','gain','get','chip','fruit machine','bonus'], zh:['遊樂場','博弈','賭場','拉霸機','老虎機','中大獎','輪盤','電玩機台','硬幣','獲勝','收集','獲得'] }
  },
  { id:'CART', name:'Cartoon / Comedy', zh:'卡通 / 綜藝', color:'#ffb347',
    subs:['Boing 彈跳','Fall Drop 墜落','Slip 滑倒','Wah-wah 失敗','Laugh 笑聲','Drum roll 鼓陣'],
    keywords:{ en:['cartoon','comedy','boing','fall','drop','slip','wah-wah','laugh track','rimshot','drum roll','squeak','slide whistle','accent','funny','comic','glissando','bounce','bonk','plop','whoosh comedy','spring','tumble'], zh:['卡通','綜藝','搞笑','罐頭笑聲','彈簧','彈跳','滑倒','失敗','烏鴉飛過','滑音','綜藝摔','敲頭','墜落','掉落'] }
  },
  { id:'DSGN', name:'Sound Design', zh:'設計音 / 預告片', color:'#5b9fff',
    subs:['Rise 爬升','Drop 墜落','Hit 重擊','Braam 銅管重音','Sweep 掃過','Flash 閃現'],
    keywords:{ en:['sound design','rise','riser','drop','downer','braam','boom','hit','impact','sweep','swoosh','whoosh hit','glitch','tension','cinematic','trailer','build-up','sub bass','reverse','stutter','whoosh sting','flash','shimmer'], zh:['設計音','預告片','電影感','廣告','爬升','墜落','重擊','掃過','反轉','重低音','緊張感','閃現','閃光'] }
  },
  { id:'ELEC', name:'Electricity', zh:'電流 / 電子', color:'#c8f060',
    subs:['Spark 火花','Zap 電擊','Shock 觸電','Arc 電弧','Hum 電流聲','Flash 閃爍'],
    keywords:{ en:['electricity','electric','elecetric','spark','zap','shock','static','arc','buzz','hum','short circuit','power','flash','lightning','energy'], zh:['電流','電子','火花','電擊','觸電','電弧','短路','能量','閃爍','電力'] }
  },
  { id:'EXP', name:'Explosion', zh:'爆炸 / 爆破', color:'#ff6b5b',
    subs:['Bomb 炸彈','Firework 煙火','Gas 氣體爆炸','Nuclear 核爆','Debris 碎片','Shockwave 衝擊波'],
    keywords:{ en:['explosion','boom','blast','bang','detonation','burst','bomb','grenade','dynamite','shockwave','debris','rubble','fire','nuclear','gas explosion','underwater explosion','firework','crack','rumble','tail'], zh:['爆炸','爆破','引爆','轟鳴','爆裂','炸彈','手榴彈','煙火','鞭炮','衝擊波','碎片','核爆','水下爆炸','大爆炸'] }
  },
  ...
  { id:'MAG', name:'Magic / Sci-Fi', zh:'魔法 / 科幻', color:'#5b9fff',
    ...
    keywords:{ en:['magic','spell','cast','enchant','arcane','mystical','shimmer','sparkle','twinkle','shine','flash','glow','portal','teleport','laser','beam','energy','shield','barrier','lightning','thunder','sci-fi','futuristic','electric','plasma','charge','heal','buff'], zh:['魔法','咒語','施法','閃耀','光亮','發光','光芒閃爍','傳送門','雷射','能量','護盾','火系魔法','閃電','科幻','電流','治癒','補血','蓄力'] }
  },
  ...
  { id:'UI', name:'UI / Notification', zh:'介面音效 / 通知', color:'#5b9fff',
    ...
    keywords:{ en:['notification','alert','ping','ding','chime','beep','pop','success','complete','win','unlock','reward','level up','collect','gain','get','acquire','positive','error','fail','wrong','deny','buzz','decline','click','tap','toggle','swipe','transition','UI','interface','game sound','achievement','coin','inventory','typing'], zh:['通知','提醒','提示音','叮聲','鐘聲','嗶聲','彈出音','成功','完成','勝利','解鎖','獎勵','收集','獲得','升級','錯誤','失敗','拒絕','蜂鳴','點擊','轉場','介面音','遊戲音效','金幣'] }
  },
  { id:'NAT', name:'Nature / Animals', zh:'自然 / 動物', color:'#c8f060',
    subs:['Thunder 雷聲','Wind 風','Fire 火','Animal 動物','Birds 鳥鳴','Insects 昆蟲'],
    keywords:{ en:['thunder','lightning strike','wind gust','storm','fire crackling','fire','flame','animal','creature','beast','bird','wolf','bear','horse','insect','cricket','frog','earth','rock','gravel','leaves','branch','tree','nature'], zh:['雷聲','閃電','暴風雨','火焰','動物','生物','野獸','鳥鳴','狼嚎','馬嘶','昆蟲','青蛙','樹葉'] }
  },
...
const DIMS = {
  genre:{ label:'Genre / Media', zh:'媒體與風格', color:'#5b9fff', tokens:{
    'comedy|variety|cartoon|綜藝|搞笑|喜劇|趣味|罐頭音效|綜藝摔|烏鴉飛過':{ en:['comedy','variety show','cartoon','funny','silly','boing','laugh track','rimshot','funny slide'], zh:['綜藝','搞笑','卡通','喜劇','罐頭笑聲','彈簧'] },
    ...
    'casino|arcade|賭場|博弈|拉霸|老虎機':{ en:['casino','arcade','slot machine','jackpot','gamble','fruit machine','gambling'], zh:['賭場','博弈','拉霸機','老虎機','遊樂場'] }
  }},
  emotion:{ label:'Emotion / Vibe', zh:'情緒 / 氛圍', color:'#ffb347', tokens:{
    ...
    'positive|happy|win|正向|開心|愉悅|成功|肯定|贏':{ en:['positive','happy','cheerful','success','confirm','accept','reward','win','gain'], zh:['正向','開心','成功','肯定','獲得','勝利'] },
  ...
  action:{ label:'Action', zh:'動作', color:'#f06090', tokens:{
    ...
    'explosion|burst|爆|炸|爆炸|爆裂|炸開|爆發|firework|煙火':{ en:['explosion','blast','boom','burst','bang','detonate','shockwave','firework','crack'], zh:['爆炸','爆裂','爆破','衝擊波','煙火','鞭炮'] },
    ...
    'charge|riser|rise|build|蓄力|聚能|爬升|集氣|充能':{ en:['charge','charge up','riser','rise','build-up','power up','crescendo','swell'], zh:['蓄力','充能','爬升','升起','聚能'] },
    'collect|gain|get|收集|獲得|取得|得到|撿起':{ en:['collect','gain','get','acquire','pickup','obtain','receive'], zh:['收集','獲得','取得','撿起'] },
  }},
  ...
  creature:{ label:'Creature / Animal', zh:'生物 / 動物', color:'#c8f060', tokens:{
    'animal|beast|creature|動物|生物|猛獸|野獸':{ en:['animal','creature','beast','monster','wildlife'], zh:['動物','生物','猛獸','野獸','野生'] },
    ...
    'bear|monster|熊|怪物|巨獸|咆哮|嘶吼|怒吼|生化|變異':{ en:['bear','monster','roar','growl','creature','beast','snarl','creature scream','mutant','alien'], zh:['熊吼','怪物','野獸','咆哮','嘶吼','異形'] },
  ...
  mechanical:{ label:'Mechanical', zh:'機械 / 工業', color:'#ffb347', tokens:{
    ...
    'gear|齒輪|機械|咬合|棘輪|機械聲':{ en:['gear','cog','ratchet','mechanical click','machinery','gear shift'], zh:['齒輪','棘輪','機械','咬合','轉動'] },
    ...
    'electric|elecetric|spark|zap|電流|電力|火花|觸電|靜電':{ en:['electric','electricity','elecetric','spark','zap','shock','static','arc','surge'], zh:['電流','電力','觸電','火花','電擊','電弧'] },
  ...
  magic:{ label:'Magic / Sci-Fi', zh:'魔法 / 科幻', color:'#5b9fff', tokens:{
    ...
    'lightning|thunder magic|閃電|雷電|電擊|閃電魔法|電魔法':{ en:['lightning','electric','elecetric','thunder magic','shock','zap','spark','lightning strike'], zh:['閃電','電擊','雷電','閃電術'] },
    ...
    'shimmer|sparkle|shine|flash|光芒|閃爍|魔法粒子|閃耀|光效|粒子|閃現|發光':{ en:['shimmer','sparkle','twinkle','shine','flash','glow','glare','fairy','magical glow','particle'], zh:['光芒閃爍','閃耀','魔法粒子','閃現','發光'] },
  ...
  ui:{ label:'UI / Interface', zh:'介面音效', color:'#5b9fff', tokens:{
    ...
    'success|complete|win|成功|完成|勝利|解鎖|升級|獎勵|達成|任務|獲勝|贏':{ en:['success','complete','win','unlock','reward','level up','achievement','fanfare','triumph','quest complete'], zh:['成功','完成','勝利','解鎖','獎勵','升級','任務完成','獲勝'] },
    ...
    'gain|get|collect|獲得|取得|得到|收集|獲取':{ en:['gain','get','collect','acquire','receive','obtain','fetch'], zh:['獲得','取得','得到','收集','獲取'] },
